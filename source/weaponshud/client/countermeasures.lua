...
function CM_DeployChaff(veh)
  ...
  Net_SendCountermeasure("chaff", NetworkGetNetworkIdFromEntity(veh))
...
function CM_DeployChaffRemote(veh)
  ...
  local pos = GetEntityCoords(veh)
  local offsets = {
    GetOffsetFromEntityInWorldCoords(veh, -5.5, -4.5, -0.2),
    GetOffsetFromEntityInWorldCoords(veh, 5.5, -4.5, -0.2),
  }
  ...
  StartParticleFxNonLoopedAtCoord("exp_grd_grenade_smoke", pos.x, pos.y, pos.z, 0.0, 0.0, 0.0, 0.25, false, false, false)
end
